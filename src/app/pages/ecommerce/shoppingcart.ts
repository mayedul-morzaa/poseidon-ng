    ...
    template: `
        <div class="card">
            <div class="flex flex-col items-center mb-12">
                <div class="text-surface-900 dark:text-surface-0 text-4xl mb-6 font-medium">Your cart total is $82.00
                </div>
                <p class="text-surface-700 dark:text-surface-100 font-medium text-xl mt-0 mb-6">FREE SHIPPING AND
                    RETURN</p>
            ...
            <ul class="list-none p-0 m-0">
                <li class="flex flex-col md:flex-row py-12 border-t border-b border-surface-200 dark:border-surface-700 md:items-center">
                    <img
                        src="https://fqjltiegiezfetthbags.supabase.co/storage/v1/render/image/public/block.images/blocks/ecommerce/shoppingcart/shopping-cart-2-1.png"
                        class="w-48 shrink-0 mx-auto md:mx-0" alt="shopping-cart-2-1"/>
                    <div class="flex-auto py-8 md:pl-8">
                        <div
                            ...
                            <div class="w-full sm:w-6/12 flex flex-col">
                                <span
                                    class="text-surface-900 dark:text-surface-0 text-xl font-medium mb-4">Product Name</span>
                            ...
                            <div class="w-full sm:w-6/12 flex items-start justify-between mt-4 sm:mt-0">
                                ...
                                <div class="flex flex-col sm:items-end">
                                    ...
                                    <a class="cursor-pointer text-pink-500 font-medium text-sm hover:text-pink-600 transition-colors duration-300"
                                       tabindex="0"> Remove </a>
                                </div>
                            </div>
                        </div>
                ...
                <li class="flex flex-col md:flex-row py-12 border-t border-b border-surface-200 dark:border-surface-700 md:items-center">
                    <img
                        src="https://fqjltiegiezfetthbags.supabase.co/storage/v1/render/image/public/block.images/blocks/ecommerce/shoppingcart/shopping-cart-2-2.png"
                        class="w-48 shrink-0 mx-auto md:mx-0" alt="shopping-cart-2-2"/>
                    <div class="flex-auto py-8 md:pl-8">
                        <div
                            class="flex flex-wrap items-start sm:items-center sm:flex-row sm:justify-between border-surface-200 dark:border-surface-700 pb-12">
                            <div class="w-full sm:w-6/12 flex flex-col">
