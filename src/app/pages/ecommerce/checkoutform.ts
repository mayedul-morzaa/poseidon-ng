            ...
            <div class="grid grid-cols-12 gap-4 grid-nogutter">
                ...
                <div class="col-span-12 lg:col-span-6 px-6 py-6 md:px-12">
                    ...
                    <div class="flex flex-col lg:flex-row flex-wrap lg:items-center py-2 mt-4 border-surface-200 dark:border-surface-700">
                        <img src="https://fqjltiegiezfetthbags.supabase.co/storage/v1/render/image/public/block.images/blocks/ecommerce/checkoutform/checkoutform-1-2.png" class="w-32 h-32 shrink-0 mb-4" alt="product" />
