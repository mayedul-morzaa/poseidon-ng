    ...
    template: `
        <div>
            <div>
                ...
                <p class="mt-3.5 max-w-lg mx-auto text-center text-surface-500 dark:text-white/64">Get clear answers and
                    helpful guidance on the most common questions about our services and products.</p>
            </div>
