import{a as P}from"./chunk-ENUBIGUT.js";import{a as K,d as lt,g as at,k as rt}from"./chunk-PWIRR5TW.js";import{b as st}from"./chunk-WAENNQN7.js";import{Ba as j,Y as $,Z as L,sa as Q,ta as u}from"./chunk-AY2ARFMM.js";import{o as N,s as R}from"./chunk-QIAVZCJE.js";import{$ as U,$a as I,Ab as w,Bb as tt,Fb as V,Fc as s,Gb as r,Gc as z,Jb as c,Lb as g,Ma as d,Mb as p,Q as B,R as O,S as M,Tb as b,Ub as et,Vb as nt,W as S,Xa as D,Ya as F,aa as Y,ab as J,ac as A,bb as h,cc as G,db as x,dc as ot,lb as y,mb as _,na as m,nb as v,oc as it,pb as W,qb as X,rb as C,sb as T,tb as k,ub as Z,xc as E}from"./chunk-YSO2AELB.js";var ut=`
    .p-togglebutton {
        display: inline-flex;
        cursor: pointer;
        user-select: none;
...
`;var ht=["icon"],yt=["content"],ct=e=>({$implicit:e});function _t(e,a){e&1&&w(0)}function vt(e,a){if(e&1&&Z(0,"span"),e&2){let t=r(3);b(t.cn(t.cx("icon"),t.checked?t.onIcon:t.offIcon,t.iconPos==="left"?t.cx("iconLeft"):t.cx("iconRight"))),y("data-pc-section","icon")}}function Ct(e,a){if(e&1&&_(0,vt,1,3,"span",1),e&2){let t=r(2);v(t.onIcon||t.offIcon?0:-1)}}function xt(e,a){e&1&&w(0)}function Tt(e,a){if(e&1&&h(0,xt,1,0,"ng-container",0),e&2){let t=r(2);C("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)("ngTemplateOutletContext",G(2,ct,t.checked))}}function kt(e,a){if(e&1&&(_(0,Ct,1,1)(1,Tt,1,4,"ng-container"),T(2,"span"),et(3),k()),e&2){let t=r();v(t.iconTemplate?1:0),d(2),b(t.cx("label")),y("data-pc-section","label"),d(),nt(t.checked?t.hasOnLabel?t.onLabel:"\xA0":t.hasOffLabel?t.offLabel:"\xA0")}}var wt=`
    ${ut}
...
`,Et={root:({instance:e})=>["p-togglebutton p-component",{"p-togglebutton-checked":e.checked,"p-invalid":e.invalid(),"p-disabled":e.$disabled(),"p-togglebutton-sm p-inputfield-sm":e.size==="small","p-togglebutton-lg p-inputfield-lg":e.size==="large","p-togglebutton-fluid":e.fluid()}],content:"p-togglebutton-content",icon:"p-togglebutton-icon",iconLeft:"p-togglebutton-icon-left",iconRight:"p-togglebutton-icon-right",label:"p-togglebutton-label"},dt=(()=>{class e extends j{name="togglebutton";theme=wt;classes=Et;static \u0275fac=(()=>{let t;return function(o){return(t||(t=m(e)))(o||e)}})();static \u0275prov=O({token:e,factory:e.\u0275fac})}return e})();var Lt={provide:K,useExisting:B(()=>H),multi:!0},H=(()=>{class e extends P{onKeyDown(t){switch(t.code){case"Enter":this.toggle(t),t.preventDefault();break;case"Space":this.toggle(t),t.preventDefault();break}}toggle(t){!this.$disabled()&&!(this.allowEmpty===!1&&this.checked)&&(this.checked=!this.checked,this.writeModelValue(this.checked),this.onModelChange(this.checked),this.onModelTouched(),this.onChange.emit({originalEvent:t,checked:this.checked}),this.cd.markForCheck())}onLabel="Yes";offLabel="No";onIcon;offIcon;ariaLabel;ariaLabelledBy;styleClass;inputId;tabindex=0;iconPos="left";autofocus;size;allowEmpty;fluid=E(void 0,{transform:s});onChange=new x;iconTemplate;contentTemplate;templates;checked=!1;_componentStyle=S(dt);onBlur(){this.onModelTouched()}get hasOnLabel(){return this.onLabel&&this.onLabel.length>0}get hasOffLabel(){return this.onLabel&&this.onLabel.length>0}get active(){return this.checked===!0}_iconTemplate;_contentTemplate;ngAfterContentInit(){this.templates.forEach(t=>{switch(t.getType()){case"icon":this._iconTemplate=t.template;break;case"content":this._contentTemplate=t.template;break;default:this._contentTemplate=t.template;break}})}writeControlValue(t,n){this.checked=t,n(t),this.cd.markForCheck()}static \u0275fac=(()=>{let t;return function(o){return(t||(t=m(e)))(o||e)}})();static \u0275cmp=D({type:e,selectors:[["p-toggleButton"],["p-togglebutton"],["p-toggle-button"]],contentQueries:function(n,o,i){if(n&1&&(c(i,ht,4),c(i,yt,4),c(i,Q,4)),n&2){let l;g(l=p())&&(o.iconTemplate=l.first),g(l=p())&&(o.contentTemplate=l.first),g(l=p())&&(o.templates=l)}},hostVars:6,hostBindings:function(n,o){n&1&&V("keydown",function(l){return o.onKeyDown(l)})("click",function(l){return o.toggle(l)}),n&2&&(y("aria-labelledby",o.ariaLabelledBy)("aria-pressed",o.checked)("role","button")("tabindex",o.$disabled()?-1:0),b(o.cn(o.cx("root"),o.styleClass)))},inputs:{onLabel:"onLabel",offLabel:"offLabel",onIcon:"onIcon",offIcon:"offIcon",ariaLabel:"ariaLabel",ariaLabelledBy:"ariaLabelledBy",styleClass:"styleClass",inputId:"inputId",tabindex:[2,"tabindex","tabindex",z],iconPos:"iconPos",autofocus:[2,"autofocus","autofocus",s],size:"size",allowEmpty:"allowEmpty",fluid:[1,"fluid"]},outputs:{onChange:"onChange"},features:[A([Lt,dt]),J([st]),I],decls:3,vars:7,consts:[[4,"ngTemplateOutlet","ngTemplateOutletContext"],[3,"class"]],template:function(n,o){n&1&&(T(0,"span"),h(1,_t,1,0,"ng-container",0),_(2,kt,4,5),k()),n&2&&(b(o.cx("content")),d(),C("ngTemplateOutlet",o.contentTemplate||o._contentTemplate)("ngTemplateOutletContext",G(5,ct,o.checked)),d(),v(o.contentTemplate?-1:2))},dependencies:[R,N,u],encapsulation:2,changeDetection:0})}return e})(),ne=(()=>{class e{static \u0275fac=function(n){return new(n||e)};static \u0275mod=F({type:e});static \u0275inj=M({imports:[H,u,u]})}return e})();var gt=`
    .p-selectbutton {
        display: inline-flex;
        user-select: none;
