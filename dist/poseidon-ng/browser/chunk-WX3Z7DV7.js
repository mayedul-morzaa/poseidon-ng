import{a as ce}from"./chunk-36MYCZTL.js";import{a as ie}from"./chunk-ENUBIGUT.js";import{a as te}from"./chunk-XAP2DVZB.js";import{a as ne,c as oe}from"./chunk-PWIRR5TW.js";import{Ba as ee,Z as W,_ as Y,sa as Z,ta as v}from"./chunk-AY2ARFMM.js";import{i as U,k as K,o as X,s as J}from"./chunk-QIAVZCJE.js";import{$ as k,$a as Q,Bb as j,Fb as A,Fc as p,Gb as s,Gc as P,Jb as T,Kb as $,Lb as m,Ma as d,Mb as _,Q as B,R as F,S,Sb as q,Tb as l,W as E,Xa as O,Ya as L,aa as x,ac as R,ba as y,bb as u,db as f,dc as G,ia as D,lb as h,ma as N,na as C,rb as a,sb as w,tb as I,tc as H,ub as g,xc as z,yb as V,zb as M}from"./chunk-YSO2AELB.js";var ae=`
    .p-checkbox {
        position: relative;
        display: inline-flex;
        user-select: none;
...
`;var le=["checkboxicon"],he=["input"],se=(e,r)=>({checked:e,class:r});function be(e,r){if(e&1&&g(0,"span",7),e&2){let o=s(3);l(o.cx("icon")),a("ngClass",o.checkboxIcon),h("data-pc-section","icon")}}function ue(e,r){if(e&1&&(y(),g(0,"svg",8)),e&2){let o=s(3);l(o.cx("icon")),h("data-pc-section","icon")}}function pe(e,r){if(e&1&&(V(0),u(1,be,1,4,"span",5)(2,ue,1,3,"svg",6),M()),e&2){let o=s(2);d(),a("ngIf",o.checkboxIcon),d(),a("ngIf",!o.checkboxIcon)}}function ke(e,r){if(e&1&&(y(),g(0,"svg",9)),e&2){let o=s(2);l(o.cx("icon")),h("data-pc-section","icon")}}function xe(e,r){if(e&1&&(V(0),u(1,pe,3,2,"ng-container",2)(2,ke,1,3,"svg",4),M()),e&2){let o=s();d(),a("ngIf",o.checked),d(),a("ngIf",o._indeterminate())}}function fe(e,r){}function ge(e,r){e&1&&u(0,fe,0,0,"ng-template")}var me=`
    ${ae}
